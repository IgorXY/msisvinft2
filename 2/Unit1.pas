   ...
   case RadioGroup1.ItemIndex of
      0:
         begin
            ...
            Label1.Caption:='Биты текста:';
            Label2.Caption:='Биты ключа:';
            Label3.Caption:='Биты шифра:';
         end;
      1:
         begin
            show_bytes := false;
      ...
      2:
         begin
            ...
            Label6.Visible := false;
            Label7.Visible := true;
            Label1.Caption:='Байты текста:';
            Label2.Caption:='Байты ключа:';
            Label3.Caption:='Байты шифра:';
         end;
